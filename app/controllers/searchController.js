...
kommunalApp.controller('searchController', function($scope, $rootScope, $timeout, $location, $routeParams, $filter, $cookies) {
    ...
    $scope.doSearch    = function(){
        if ($scope.search.nameSearch.length != 0){
